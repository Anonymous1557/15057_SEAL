...
class PeftConfigMixin(PushToHubMixin):
    ...
    def save_pretrained(self, save_directory, **kwargs):
        ...
        # move below codes into SealConfig and rewrite
        # TODO : custom details into auto_mapping
        # and see seal_nlp_inference.ipynd
        
        # output_dict = asdict(self)
        output_dict = self.to_dict() # <- why not using self.to_dict()?
        output_path = os.path.join(save_directory, CONFIG_NAME)

        # Add auto mapping details for custom models.
        if auto_mapping_dict is not None:
            output_dict["auto_mapping"] = auto_mapping_dict
        # move above codes into SealConfig and rewrite
