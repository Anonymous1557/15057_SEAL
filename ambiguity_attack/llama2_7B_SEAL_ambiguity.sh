...
output_dir=$base_model-$adapter_name-r$1-alpha$2-lr$lr-ambiguity
wandb_run_name=$base_model-$adapter_name-r$1-alpha$2-lr$lr-ambiguity
...
NCCL_P2P_DISABLE=1 accelerate launch --config_file=./ddp.yaml  \
    ...
    --key_list '["./keys/Yann_LeCun_Cropped.png", "./keys/random_100_32_32.npy"]'
