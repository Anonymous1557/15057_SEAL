...
output_dir=$base_model-$adapter_name-r$1-alpha$2-finetune
wandb_run_name=$base_model-$adapter_name-r$1-alpha$2-finetune
...
NCCL_P2P_DISABLE=1 accelerate launch --config_file=./ddp.yaml  \
    ...
    --save_strategy steps --save_total_limit 250 --save_only_model True \
    ...
    --resume_from_checkpoint ./checkpoint-31932_sealed
